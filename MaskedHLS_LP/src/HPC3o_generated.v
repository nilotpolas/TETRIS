...
//INPUTS
    ...
    input  [7:0] w1;
    input  [7:0] rand_01;
    input  [7:0] rand_prime_01;
//OUTPUTS
    output reg  [7:0] c0;
    output reg  [7:0] c1;
//Intermediate values
    wire [7:0] xor_br_hpc3o_first_half_1_order0;
    wire [7:0] and_ar_hpc3o_first_half_1_order0;
    wire [7:0] xor_step1_hpc3o_first_half_1_order0;
    wire [7:0] xor_step2_hpc3o_first_half_1_order0;
    reg [7:0] w01;
    wire [7:0] xor_br_hpc3o_v_1_order0;
    reg [7:0] temp_hpc3o_v_1_order0;
    wire [7:0] and_ta_hpc3o_v_1_order0;
    wire [7:0] v01;
    wire [7:0] u01;
    wire [7:0] xor_br_hpc3o_first_half_1_order1;
    wire [7:0] and_ar_hpc3o_first_half_1_order1;
    wire [7:0] xor_step1_hpc3o_first_half_1_order1;
    wire [7:0] xor_step2_hpc3o_first_half_1_order1;
    reg [7:0] w10;
    wire [7:0] xor_br_hpc3o_v_1_order1;
    reg [7:0] temp_hpc3o_v_1_order1;
    wire [7:0] and_ta_hpc3o_v_1_order1;
    wire [7:0] v10;
    wire [7:0] u10;
